...
class PopularModel {
  ...
  factory PopularModel.fromJSON(Map<String, dynamic> mapa){
    ...
    posterPath: mapa['poster_path'] ?? '', //si traes un valor nulo entonces te asigno un valor vacio.
    title: mapa['title'],
    voteAverage: mapa['vote_average'] is int ? (mapa['vote_average'] as int).toDouble() : mapa['vote_average'], //conversion de int a double.
